...
BLOG_AUTHOR = "Loyal Goff"  # (translatable)
...
BLOG_EMAIL = "loyalgoff@jhmi.edu"
BLOG_DESCRIPTION = "Dispatches from the neurogenic niche. Cells, sequences, and cephalopods."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> &middot; The Goff Lab &middot; Johns Hopkins School of Medicine &middot; Built with <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
<link rel="mask-icon" href="%(site)sfavicon.svg" color="#f4e7c5">
""" % {"site": SITE_URL}
